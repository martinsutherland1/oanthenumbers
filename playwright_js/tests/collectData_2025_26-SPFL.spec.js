...
async function getStatPair(page, label, numericParser) {
  ...
  for (const roundKey of roundKeys) {
    ...
    await page.goto(
      `https://www.fotmob.com/en-GB/leagues/64/fixtures/premiership?group=by-round&season=2025-2026&round=${roundIndex}`
    );
    ...
    saveJSON("./collectedData/SPFL_data_2024_24.json", seasonData);
  }
});
