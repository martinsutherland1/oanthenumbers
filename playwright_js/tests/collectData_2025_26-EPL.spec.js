...
async function getStatPair(page, label, numericParser) {
  ...
  for (const roundKey of roundKeys) {
    ...
    await page.goto(
      `https://www.fotmob.com/en-GB/leagues/47/fixtures/premier-league?group=by-round&season=2025-2026&round=${roundIndex}`
    );
    ...
    saveJSON("./collectedData/EPL_data_2025_26.json", seasonData);
  }
});
